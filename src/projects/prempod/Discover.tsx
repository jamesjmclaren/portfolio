      ...
      <div className="mx-auto max-w-6xl px-6 py-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {trending.map((t, i) => (
            ...
            >
              <div
                className={`aspect-video bg-gradient-to-br ${t.bg} relative flex items-center justify-center font-mono text-3xl font-bold text-white/90`}
              >
                {t.initials}
                ...
                <span className="absolute top-2 left-2 text-[10px] uppercase tracking-wider bg-black/60 backdrop-blur px-1.5 py-0.5 rounded">
                  {t.platform}
                </span>
              </div>
              <div className="p-3.5">
                <div className="flex items-center gap-2 mb-1">
                  <div
                    className={`size-4 rounded ${t.clubBg} flex items-center justify-center text-[7px] font-bold shrink-0`}
                  >
                    {t.club.slice(0, 3).toUpperCase()}
                  </div>
