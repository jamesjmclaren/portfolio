      ...
      <div className="relative flex items-start justify-center min-h-full p-6">
        <div className="w-full max-w-3xl rounded-2xl border border-white/10 bg-[#0a0a0f]/95 shadow-2xl overflow-hidden">
          ...
          <div className="px-6 pt-6 pb-4 flex items-start gap-4 border-b border-white/10">
            <div className="size-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center overflow-hidden shrink-0">
            ...
            <div>
              ...
              <div className="space-y-2">
                {similarToFeatured.map((s) => (
                  ...
                  >
                    <div className="size-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center overflow-hidden shrink-0">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img
                        src={s.logo}
                        alt={`${s.name} logo`}
